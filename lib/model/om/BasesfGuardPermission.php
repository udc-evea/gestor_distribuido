...
abstract class BasesfGuardPermission extends BaseObject implements Persistent
{
     ...
     *
     * @param  sfGuardGroup $sfGuardGroup The sfGuardGroupPermission object to relate
     * @return sfGuardPermission The current object (for fluent API support)
     */
    ...
    protected function doAddsfGuardGroup($sfGuardGroup)
    {
        ...
        $sfGuardGroupPermission->setsfGuardGroup($sfGuardGroup);
        $this->addsfGuardGroupPermission($sfGuardGroupPermission);
    }
     ...
     *
     * @param  sfGuardUser $sfGuardUser The sfGuardUserPermission object to relate
     * @return sfGuardPermission The current object (for fluent API support)
     */
    ...
    protected function doAddsfGuardUser($sfGuardUser)
    {
        ...
        $sfGuardUserPermission->setsfGuardUser($sfGuardUser);
        $this->addsfGuardUserPermission($sfGuardUserPermission);
    }
