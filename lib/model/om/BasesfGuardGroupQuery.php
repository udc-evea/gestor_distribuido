...
abstract class BasesfGuardGroupQuery extends ModelCriteria
{
     ...
     * using the sf_guard_group_permission table as cross reference
     *
     ...
     * @return   sfGuardGroupQuery The current query, for fluid interface
     */
    public function filterBysfGuardUser($sfGuardUser, $comparison = Criteria::EQUAL)
    {
        return $this
            ->usesfGuardUserGroupQuery()
            ->filterBysfGuardUser($sfGuardUser, $comparison)
            ->endUse();
    }
